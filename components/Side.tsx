        ...
        <div className="space-y-3 py-6">
          ...
          <div className="space-y-3 text-center">
            ...
            <div className="px-3 mx-auto w-max flex justify-center align-center border-t border-gray-900">
              <a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-3 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
              ...
              <a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-3 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
              ...
              <a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-3 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
              ...
              <a rel="noopener noreferrer" href="#" aria-label="Email" className="p-3 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
